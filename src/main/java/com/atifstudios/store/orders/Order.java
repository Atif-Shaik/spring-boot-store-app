...
import com.atifstudios.store.carts.Cart;
import com.atifstudios.store.payments.PaymentStatus;
...
public class Order {
    ...
    public static Order fromCart(Cart cart, User customer) {
        ...
        cart.getItems().forEach( cartItem -> { // this will add each product to order
